package com.weng.demo_man.codeglance.panel.scroll
...
import com.weng.demo_man.codeglance.CURRENT_EDITOR_DIFF_VIEW
import com.weng.demo_man.codeglance.config.CodeGlanceConfig.Companion.setWidth
import com.weng.demo_man.codeglance.config.enums.ClickTypeEnum
import com.weng.demo_man.codeglance.config.enums.MouseJumpEnum
import com.weng.demo_man.codeglance.panel.GlancePanel
import com.weng.demo_man.codeglance.panel.GlancePanel.Companion.fitLineToEditor
...
class ScrollBar(private val glancePanel: GlancePanel) : MouseAdapter() {
	...
	private fun resizeGlancePanel(refreshImage: Boolean) {
		...
		val diffViewer = editor.getUserData(com.weng.demo_man.codeglance.CURRENT_EDITOR_DIFF_VIEW)
		if (diffViewer != null) {
