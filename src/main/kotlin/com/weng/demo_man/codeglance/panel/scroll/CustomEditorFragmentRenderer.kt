...
import com.weng.demo_man.codeglance.panel.scroll.ScrollBar.Companion.PREVIEW_LINES
...
class CustomEditorFragmentRenderer(private val myEditor:EditorImpl){
	...
	private inner class EditorFragmentPreviewPanel(private val myContentInsets:Int,
		...
		override fun getPreferredSize(): Dimension {
			...
			var width = (gutter.width + myEditor.scrollingModel.visibleArea.width - myEditor.scrollPane.verticalScrollBar.width)
