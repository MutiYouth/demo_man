...
public class ROSSettings implements PersistentStateComponent<ROSSettings.State> {
    private static final Logger LOG = Logger.getLogger("#com.weng.demo_man.settings.ROSSettings");
     ...
     *                        See {@link com.weng.demo_man.pkg.xml.ROSLicenses.LicenseEntity#getLink(String)} for details
     */
