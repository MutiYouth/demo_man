package com.weng.demo_man.pkg.xml.completion;
...
import com.weng.demo_man.pkg.xml.*;
import com.weng.demo_man.pkg.xml.condition.psi.ROSConditionTypes;
...
public class PackageXmlCompletionContributor extends CompletionContributor {
    private static final Logger LOG = Logger.getLogger("#com.weng.demo_man.pkg.xml.completion.PackageXmlCompletionContributor");
