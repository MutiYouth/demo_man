...
import com.weng.demo_man.pkg.xml.ui.NewLicenseDialogue;
...
public class AddLicenseFileFix implements LocalQuickFix {
    private static final Logger LOG = Logger.getLogger("#com.weng.demo_man.pkg.xml.intention.AddLicenseFileFix");
