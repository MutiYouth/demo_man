...
import com.weng.demo_man.pkg.psi.impl.ROSDepKey;
import com.weng.demo_man.settings.ROSSettings;
import com.weng.demo_man.ui.HistoryKey;
...
public class ROSDepKeyCacheImpl implements ROSDepKeyCache {
    private static final Logger LOG = Logger.getLogger("#com.weng.demo_man.pkg.ROSDepKeyCacheImpl");
