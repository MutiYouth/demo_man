package com.weng.demo_man.buildtool;
...
import com.weng.demo_man.ui.PathListUtil;
...
public class ROSProfileDatabase implements PersistentStateComponent<ROSProfileDatabase.State> {
    ...
    private static final Logger LOG = Logger.getInstance("#com.weng.demo_man.buildtool.ROSProfileDatabase");
    @NotNull
